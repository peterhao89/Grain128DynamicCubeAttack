#include"GrainV1MilpDivisionClass.h"
vector<uint32> ivAll1 = { 0xffffffff, 0xffffffff };
vector<uint32> ivAll0 = { 0,0 };
string cipherName = "GrainV1";


//Draw Upper Bound for Grain128
void drawBiasBound()
{
	...
	while (1)
	{
		...
		for (int i = 0; i < KEYLENGTH; ++i)
		{
			...
			testK0.erase(i);
			GrainV1DifferentDegrees mmy(CubeAll, ivAll0);
